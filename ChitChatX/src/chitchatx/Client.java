...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        p1.setBackground(new Color(26, 35, 126));  // Dark Blue Header
        ...
        send.setBackground(new Color(21, 101, 192));  // Medium Blue
    ...
    public static JPanel formatLabel(String out) {
        ...
        output.setBackground(new Color(100, 181, 246));  // Light Blue
